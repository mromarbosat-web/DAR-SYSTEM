...
class EconomySettings(Base):
    ...
    voice_reward_per_interval: Mapped[int] = mapped_column(BigInteger, default=50, nullable=False)
    voice_interval_minutes: Mapped[int] = mapped_column(Integer, default=5, nullable=False)
