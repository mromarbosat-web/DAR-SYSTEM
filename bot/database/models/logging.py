...
class LogSettings(Base):
    ...
    invite_log_channel_id: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
    economy_log_channel_id: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
    verification_log_channel_id: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
    automod_log_channel_id: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
