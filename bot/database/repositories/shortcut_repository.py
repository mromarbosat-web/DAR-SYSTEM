...
DEFAULT_SHORTCUTS = [
    ...
    {"trigger": "فك كتم", "action": "untimeout"},
    {"trigger": "فك عزل", "action": "untimeout"},
    {"trigger": "فك تايم", "action": "untimeout"},
    {"trigger": "طرد", "action": "kick"},
    {"trigger": "حظر", "action": "ban"},
    {"trigger": "تبنيد", "action": "ban"},
    {"trigger": "مسح", "action": "purge"},
    {"trigger": "حذف رسائل", "action": "purge"},
    {"trigger": "قفل", "action": "lock"},
    {"trigger": "فتح", "action": "unlock"},
    {"trigger": "حذف تحذير", "action": "delete_warn"},
    {"trigger": "مسح تحذير", "action": "delete_warn"},
    {"trigger": "صوت كتم", "action": "voice_mute"},
    {"trigger": "فك كتم صوتي", "action": "voice_unmute"},
    {"trigger": "صوت فك كتم", "action": "voice_unmute"},
    {"trigger": "صوت فصل", "action": "voice_disconnect"},
    {"trigger": "صوت نقل", "action": "voice_move"},
    {"trigger": "نقل صوتي", "action": "voice_move"},
    {"trigger": "بروفايل", "action": "profile"},
    {"trigger": "بروفايلي", "action": "profile"},
    {"trigger": "رصيد", "action": "balance"},
    {"trigger": "رصيدي", "action": "balance"},
    {"trigger": "فلوسي", "action": "balance"},
    {"trigger": "اموالي", "action": "balance"},
    {"trigger": "عرض رصيد", "action": "balance"},
    {"trigger": "عرض الرصيد", "action": "balance"},
    {"trigger": "المحفظة", "action": "balance"},
    {"trigger": "محفظتي", "action": "balance"},
